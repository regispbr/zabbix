...
window.widget_tablemodulerme_form = new class {
    ...
    init({templateid}) {
        ...
        // jQuery listeners for Multiselects
    ...
    #updateForm() {
        ...
        if (hostSelect && itemSelect) {
            ...
            if (hostUrlData && itemUrlData && hostUrlData.options && itemUrlData.options) {
                ...
                // Use a simpler approach to get form values if getFormFields isn't reliable here
                // Or ensure getFormFields works with the form element
                ...
                if (typeof $hostSelect.multiSelect === 'function') {
                     $hostSelect.multiSelect('modify', {url: urlHost.getUrl()});
                }
                if (typeof $itemSelect.multiSelect === 'function') {
