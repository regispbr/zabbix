...
namespace Modules\GeomapPlus\Includes;
...
class WidgetForm extends CWidgetForm {
	...
	public function addFields(): self {
		return $this
			...
			->addField(
				(new CWidgetFieldColor('color_no_problems', _('Color: No Problems')))
					->setDefault('00AA00')
			)
			->addField(
				(new CWidgetFieldColor('color_information', _('Color: Information')))
					->setDefault('7499FF')
			)
			->addField(
				(new CWidgetFieldColor('color_warning', _('Color: Warning')))
					->setDefault('FFC859')
			)
			->addField(
				(new CWidgetFieldColor('color_average', _('Color: Average')))
					->setDefault('FFA059')
			)
			->addField(
				(new CWidgetFieldColor('color_high', _('Color: High')))
					->setDefault('E97659')
			)
			->addField(
				(new CWidgetFieldColor('color_disaster', _('Color: Disaster')))
					->setDefault('E45959')
			)
			->addField(
