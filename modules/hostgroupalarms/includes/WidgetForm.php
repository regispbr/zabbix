	...
	public function addFields(): self {
		...
		$this->addField(
			(new CWidgetFieldCheckBox('show_acknowledged', _('Show acknowledged')))
				->setDefault(1) // 1 = Show All (checked), 0 = Unack Only
		);
		...
		$this->addField(
			(new CWidgetFieldCheckBox('show_detailed_tooltip', _('Show detailed tooltip')))
				->setDefault(1)
		);

		$this->addField(
			(new CWidgetFieldIntegerBox('tooltip_max_items', _('Tooltip max items')))
				->setDefault(10)
		);
