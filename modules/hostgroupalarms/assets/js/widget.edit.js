...
jQuery(function($) {
	...
	function initializeHostGroupAlarmsForm() {
		...
		const formFields = [
			'hostgroups',
			'hosts', 
			'exclude_hosts', // ADICIONADO
			'evaltype', // ADICIONADO
			'tags', // ADICIONADO
			'show_acknowledged', // ADICIONADO
		...
		// ----- ADICIONADO: 'change' para o novo campo de tags -----
	...
	function getSeverityColors(severity) {
		const colorMap = {
			'-1': { background: '#66BB6A', text: '#000000' }, // No alarms - green
			'0': { background: '#6BB6A', text: '#000000' },  // Not classified
			'1': { background: '#00BFFF', text: '#FFFFFF' },  // Information
			'2': { background: '#FFD54F', text: '#000000' },  // Warning
			'3': { background: '#FF9800', text: '#000000' },  // Average
			'4': { background: '#F4511E', text: '#FFFFFF' },  // High
			'5': { background: '#B71C1C', text: '#FFFFFF' }   // Disaster
		};
